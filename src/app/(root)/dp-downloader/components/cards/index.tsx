      ...
      {profileData && (
        ...
        >
          <div
            ...
            className="rounded-lg shadow-md px-default overflow-hidden"
          >
              ...
              <div className="grid items-center grid-cols-[minmax(0,1fr)_max-content] gap-4">
                <div className="col-start-1 col-end-auto">
                  <div className="relative flex items-center gap-4 flex-wrap">
                    <h2 className="text-barcelona-primary-text min-w-0 overflow-y-visible break-words relative font-bold text-system-24 whitespace-pre-line line-clamp-1">
